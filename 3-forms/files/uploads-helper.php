 ...
 * 3. Condicional que evalua si la variable global tiene un valor de array con el "name" especificado en el input
 * 4. Se capturan los valores del array en variables
